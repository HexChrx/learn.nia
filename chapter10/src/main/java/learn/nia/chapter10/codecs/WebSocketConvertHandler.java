...
public class WebSocketConvertHandler extends MessageToMessageCodec<WebSocketFrame,
    ...
    public void encode(ChannelHandlerContext ctx, WebSocketConvertHandler.MyWebSocketFrame msg,
                       List<Object> out) {
    ...
    public void decode(ChannelHandlerContext ctx, WebSocketFrame msg, List<Object> out) {
